...
- (void)setTfy_color:(NSColor *)color {
...
- (void)setTfy_backgroundColor:(NSColor *)backgroundColor {
...
- (void)setTfy_lineThroughColor:(NSColor *)lineThroughColor {
...
- (void)setTfy_underLineColor:(NSColor *)underLineColor {
...
- (void)setTfy_strokeColor:(NSColor *)strokeColor {
