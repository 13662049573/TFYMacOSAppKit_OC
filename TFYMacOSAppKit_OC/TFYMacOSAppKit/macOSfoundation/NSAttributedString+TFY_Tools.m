...
- (NSFont *)tfy_fontAtIndex:(NSUInteger)index effectiveRange:(NSRangePointer)range {
...
- (NSColor *)tfy_colorAtIndex:(NSUInteger)index effectiveRange:(NSRangePointer)range {
    return [self attribute:NSForegroundColorAttributeName atIndex:index effectiveRange:range];
}

- (NSColor *)tfy_backgroundColor {
    return [self tfy_backgroundColorAtIndex:0 effectiveRange:NULL];
}
- (NSColor *)tfy_backgroundColorAtIndex:(NSUInteger)index effectiveRange:(NSRangePointer)range {
...
- (NSColor *)tfy_lineThroughColorAtIndex:(NSUInteger)index effectiveRange:(NSRangePointer)range {
...
- (NSColor *)tfy_underLineColorAtIndex:(NSUInteger)index effectiveRange:(NSRangePointer)range {
    return [self attribute:NSUnderlineColorAttributeName atIndex:index effectiveRange:range];
}

- (NSColor *)tfy_strokeColor {
    return [self tfy_strokeColorAtIndex:0 effectiveRange:NULL];
}
- (NSColor *)tfy_strokeColorAtIndex:(NSUInteger)index effectiveRange:(NSRangePointer)range {
