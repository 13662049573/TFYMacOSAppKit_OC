 ...
 *  计算字符串长度（一行时候）
 */
- (CGSize)tfy_textSizeWithFont:(NSFont*)font limitWidth:(CGFloat)maxWidth {
...
+ (NSArray *)tfy_getLinesArrayOfStringInrowsOfString:(NSString *)text withFont:(NSFont *)font withWidth:(CGFloat)width {
