...
@property (nonatomic, strong, readwrite, nullable) NSFont *tfy_font;
@property (nonatomic, strong, readwrite, nullable) NSColor *tfy_color;
@property (nonatomic, strong, readwrite, nullable) NSColor *tfy_backgroundColor;
// paragraphStyle
...
@property (nonatomic, strong, readwrite, nullable) NSColor *tfy_lineThroughColor;
...
@property (nonatomic, strong, readwrite, nullable) NSColor *tfy_underLineColor;
@property (nonatomic, assign, readwrite) CGFloat tfy_strokeWidth;
@property (nonatomic, strong, readwrite, nullable) NSColor *tfy_strokeColor;
...
/**
 添加文本字体
 */
- (void)tfy_addFont:(NSFont *)font range:(NSRange)range;

/**
 添加文本颜色
 */
- (void)tfy_addColor:(NSColor *)color range:(NSRange)range;

/**
 添加文本背景色
 */
- (void)tfy_addBackgroundColor:(NSColor *)backgroundColor range:(NSRange)range;
...
/**
 添加文本删除线颜色
 */
- (void)tfy_addLineThroughColor:(NSColor *)color range:(NSRange)range;
...
/**
 添加文本下划线颜色
 */
- (void)tfy_addUnderLineColor:(NSColor *)color range:(NSRange)range;
...
/**
 添加文本边框颜色
 */
- (void)tfy_addStrokeColor:(NSColor *)color range:(NSRange)range;
