...
@property (nonatomic, strong, readonly, nullable) NSFont *tfy_font;          // 字体
@property (nonatomic, strong, readonly, nullable) NSColor *tfy_color;        // 颜色
@property (nonatomic, strong, readonly, nullable) NSColor *tfy_backgroundColor; // 背景颜色
// paragraphStyle
...
/**
 获取索引处的文本字体属性
 */
- (NSFont *)tfy_fontAtIndex:(NSUInteger)index effectiveRange:(nullable NSRangePointer)range;

/**
 获取索引处的文本颜色属性
 */
- (NSColor *)tfy_colorAtIndex:(NSUInteger)index effectiveRange:(nullable NSRangePointer)range;

/**
 获取索引处的文本背景颜色属性
 */
- (NSColor *)tfy_backgroundColorAtIndex:(NSUInteger)index effectiveRange:(nullable NSRangePointer)range;
...
/**
 通过index处的颜色属性获取文本行
 */
- (NSColor *)tfy_lineThroughColorAtIndex:(NSUInteger)index effectiveRange:(nullable NSRangePointer)range;
...
/**
 在索引处获取文本下划线颜色属性
 */
- (NSColor *)tfy_underLineColorAtIndex:(NSUInteger)index effectiveRange:(nullable NSRangePointer)range;
...
/**
 获取索引处的文本描边颜色属性
 */
- (NSColor *)tfy_strokeColorAtIndex:(NSUInteger)index effectiveRange:(nullable NSRangePointer)range;
