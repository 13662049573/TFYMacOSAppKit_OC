...
TFY_CATEGORY_CHAIN_VIEW_IMPLEMENTATION(macos_origin, NSPoint)

TFY_CATEGORY_CHAIN_VIEW_IMPLEMENTATION(macos_x, CGFloat)

TFY_CATEGORY_CHAIN_VIEW_IMPLEMENTATION(macos_y, CGFloat)

TFY_CATEGORY_CHAIN_VIEW_IMPLEMENTATION(macos_size, CGSize)

TFY_CATEGORY_CHAIN_VIEW_IMPLEMENTATION(macos_width, CGFloat)

TFY_CATEGORY_CHAIN_VIEW_IMPLEMENTATION(macos_height, CGFloat)

TFY_CATEGORY_CHAIN_VIEW_IMPLEMENTATION(macos_top, CGFloat)

TFY_CATEGORY_CHAIN_VIEW_IMPLEMENTATION(macos_bottom, CGFloat)

TFY_CATEGORY_CHAIN_VIEW_IMPLEMENTATION(macos_left, CGFloat)

TFY_CATEGORY_CHAIN_VIEW_IMPLEMENTATION(macos_right, CGFloat)
